...
class Stitcher:
    ...
    def initialize_stitcher(self, **kwargs):
        ...
        self.subsetter = Subsetter(args.confidence_threshold, args.matches_graph_dot_file)
        ...
        self.compensator = ExposureErrorCompensator(args.compensator, args.nr_feeds, args.block_size)
